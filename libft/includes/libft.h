...
void		ft_lstadd_front(t_list **lst, t_list *newpt);
void		ft_lstadd_back(t_list **lst, t_list *newpt);
void		ft_lstintadd_back(t_int_list **lst, t_int_list *newpt);
void		ft_lstintadd_front(t_int_list **lst, t_int_list *newpt);
